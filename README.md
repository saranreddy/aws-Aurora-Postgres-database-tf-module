...
A production-ready Terraform module for deploying AWS Aurora PostgreSQL databases with enterprise-grade configurations. This is the Aurora Postgres database standard Terraform code for UMB (University of Maryland, Baltimore) organization.
